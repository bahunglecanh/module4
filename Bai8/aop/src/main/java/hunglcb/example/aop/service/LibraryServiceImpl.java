...
import hunglcb.example.aop.repository.BookRepository;
import hunglcb.example.aop.repository.BorrowTicketRepository;
...
import static hunglcb.example.aop.service.LibraryExceptions.InvalidTicketException;
import static hunglcb.example.aop.service.LibraryExceptions.OutOfStockException;
...
public class LibraryServiceImpl implements LibraryService {
	...
	public void returnBook(String code) {
		...
		if (tickets.isEmpty()) {
			throw new InvalidTicketException("Mã mượn sách không hợp lệ");
		}
